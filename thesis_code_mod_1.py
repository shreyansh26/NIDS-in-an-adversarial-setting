...
accuracy1 = model_eval(sess, x, y, predictions, X_test_scaled, y_test, args=eval_par)
accuracy2 = model_eval(sess, x, y, predictions, X_test_adv, y_test, args=eval_par)
print("Test accuracy on normal examples: {}".format(accuracy1))
print("Test accuracy on adversarial examples: {}".format(accuracy2))
